...
namespace Catalogue.UnitTests
{
    public class ItemsControllerTest
    {
        ...
        [Fact]
        public async Task GetItemAsync_WithExistingItem_ReturnsExpectedItemFound() 
        {
            //Arrange
        ...
        public async Task GetItemsAsync_WithExistingItems_ReturnsAllItems() 
        {
            ...
            //Use this if testing a record type
        ...
        public async Task CreateItemAsync_WithItemToCreate_ReturnsCreatedItem() 
        {
           ...
           // createdItem.CreatedDate.Should().BeCloseTo(3.April(2022).At(14, 58), 10.Seconds());
